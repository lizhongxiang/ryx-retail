...
public class DesUtil {
   ...
   public static void main(String[] args) {
       ...
       String key3 = "33";
       String data = "liwei";
//       String str = DesUtil.strEnc(data, key1, null, null);
//       System.out.println(str);
//       String dec = DesUtil.strDec(str, key1, null, null);
//       System.out.println(dec);
   ...
   public static String encode(String data) {
	   return strEnc(data, "ryx", null, null);
   }

   public static String decode(String data) {
	   return strDec(data, "ryx", null, null);
   }
