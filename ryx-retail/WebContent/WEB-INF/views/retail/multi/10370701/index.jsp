...
<head>
	...
	<link href="${pageContext.request.contextPath}/public/css/common/base-all.css?v=${version }" rel="stylesheet"/>
	<link href="${pageContext.request.contextPath}/public/retail/css/retail-all.css?v=${version }" rel="stylesheet"/>
	...
	<div id="desktopcontainer">
		...
		<div id="desktop" class="navcontainer">
			<ul id="navwrap" class="navwrap">
				...
				<li class="navitem">
					<a class="navlink c12" id="dpsz" data-module="dpsz">
						<label class="navlink_back">&nbsp;</label>
						<span class="deskIcon deskIcon_dpsz"></span>
						<label class="navlink_label">店铺设置</label>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/public/js/common/jquery-help.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/public/retail/js/retail-all.js?v=${version }"></script>
