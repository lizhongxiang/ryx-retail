 ...
 * 统计分析功能
 */
HOME.Core.register("plugin-xstb", function(box) {
	
	var highchartsUrl = "public/js/common/highcharts-all1.js";
	
	var getChartsUrl = "/retail/statistics/searchSaleroom";
	...
	function showChartView(data) {
		...
		if(data && data.code == "0000") {
			...
			for(var i = 0; i < results.length; i ++){
				...
				salerooms[i] = parseFloat(results[i].saleroom);
			}			
			var content = box.ich.view_xsbb();
...
//	                }
	                ...
	                formatter: function() {
	                	 return '时间 : <b>'+ this.x +'</b><br/>'+
	                         '销售额 : <b>'+Highcharts.numberFormat( this.y,2) +'</b>';
...
//	                }
	...
	return {
		init: function(){
			box.listen("xstb", onload);
			box.listen("xstb_close",onclose);
		},
		destroy: function() { }
	};
});